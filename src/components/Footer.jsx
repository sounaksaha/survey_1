...
const Footer = () => {
  return (
    <footer className="bg-violet-500">
      <div className="mx-auto max-w-5xl py-0 px-2 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
        ...
        <div className="mt-8 md:mb-8 flex justify-center space-x-6 md:order-3">
          ...
          <a href="#" className="text-white hover:text-gray-200" aria-label="Twitter">
            <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 
              001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 
              4.107 0 00-6.993 3.743 11.65 11.65 0 
              01-8.457-4.287 4.106 4.106 0 001.27 
              5.477A4.072 4.072 0 012.8 9.713v.052a4.105 
          ...
          {/* GitHub */}
          <a href="#" className="text-white hover:text-gray-200" aria-label="GitHub">
            <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
              <path fillRule="evenodd" clipRule="evenodd"
                ...
                2.651.64.7 1.028 1.595 1.028 2.688 0 
        ...
        <div className="mt-8 md:order-1 md:mt-0">
          <p className="text-center text-base text-white">
            &copy; {new Date().getFullYear()} Shree Media Research & Surveys.<br />
            Designed By Incipient Technologies Pvt. Ltd.
          </p>
        </div>
      </div>
    </footer>
